...
public class BolAppWidgetProvider extends AppWidgetProvider {
    public static final String TO_PLAY = "in.uchneech.bol.TO_PLAY";
    private static final String PLAY_ACTION = "in.uchneech.bol.PLAY_ACTION";
    public static final String POSITION = "in.uchneech.bol.POSITION";
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < appWidgetIds.length; ++i) {
            ...
            Intent toastIntent = new Intent(context, BolAppWidgetProvider.class);
            // Set the action for the intent.
            // When the user touches a particular view, it will have the effect of
            // broadcasting TOAST_ACTION.
            toastIntent.setAction(BolAppWidgetProvider.PLAY_ACTION);
